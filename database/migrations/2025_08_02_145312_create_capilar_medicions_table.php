...
return new class extends Migration
{
    ...
    {
        Schema::create('capilar_medicions', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('glucosa_capilar')->nullable();
            $table->decimal('hemoglobina')->nullable();
            $table->decimal('tiempo_llenado_capilar')->nullable();
    ...
    {
        Schema::dropIfExists('capilar_medicions');
    }
};

...
return new class extends Migration
{
    ...
    {
        Schema::create('formulario008_examen_fisicos', function (Blueprint $table) {
            $table->id();
            ...
            //$table->text('examen_fisco_trauma')->nullable();
    ...
    {
        Schema::dropIfExists('formulario008_examen_fisicos');
    }
};
